package com.bharathksunil.interrupt.flipviewpager.view;
 ...
 *
 * @author Yalantis
 * @author Bharath changed the onTouchEvent() to respond to the touch events
 */
