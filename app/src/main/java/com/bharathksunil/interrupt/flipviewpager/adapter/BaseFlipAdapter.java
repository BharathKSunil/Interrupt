package com.bharathksunil.interrupt.flipviewpager.adapter;
...
import com.bharathksunil.interrupt.flipviewpager.view.FlipViewPager;
...
/**
 * @author Yalantis
 * @author Bharath introduced the OnItemClickListener
 */
public abstract class BaseFlipAdapter extends RecyclerView.Adapter<BaseFlipAdapter.BaseViewHolder>
     ...
     * on a close click.
     */
    private Map<Integer, FlipViewPager> flipViewPagerMap = new HashMap<>();
    private List items;
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = inflater
                .inflate(R.layout.row_orgnisers_flipper, viewGroup, false);
    ...
    public void onBindViewHolder(BaseViewHolder baseViewHolder, final int position) {
        ...
        baseViewHolder.mFlipViewPager.setOnItemClickListener(this);
    }
